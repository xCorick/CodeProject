<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Terms.aspx.cs" Inherits="CodeProject.TermsCond" %>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
          ...
          <div class="col-md-6 px-0">
             <h1 class="display-4 font-italic">Términos & condiciones</h1>
                <p class="lead my-3">Bienvenido a Uniformes Carrillo.
                 Al acceder a nuestro sitio web, usted acepta cumplir y estar sujeto a los siguientes 
                 Términos y Condiciones. Si no está de acuerdo con estos términos, por favor, no utilice el Sitio.</p>
                <hr />
                <p class="lead mb-0"><a href="Privacity.aspx" class="text-white font-weight-bold"><em>Política de privacidad</em></a></p>
           </div>  
             <div class="col-12 col-md-6" >
               <a href="Default.aspx"><img class="img-fluid rounded-start w-100 h-70 object-fit-cover" src="https://img.freepik.com/foto-gratis/primer-plano-formulario-solicitud-firma-candidato_1262-16052.jpg?t=st=1724220490~exp=1724224090~hmac=1da98a3e916cd0ebd8879b6cc3c3975c803c355808acef8c1220f3efa689c5b5&w=1380" style="width:140px; height:290px;" loading="lazy" alt="Welcome to Carrillo Shop!" /></a>
             </div>
          </div>
    ...
    <aside class="col-md-4 blog-sidebar">
      <div class="p-3 mb-3 bg-light rounded">
        ...
        <p class="mb-0">Si tiene alguna pregunta sobre las políticas de privacidad, puede contactarnos a través de <a href="#!">uniformescarrillo@gmail.com</a> o <a href="#!">6441463426</a>.</p>
          <br />
